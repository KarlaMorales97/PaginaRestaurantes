...
<body>
	...
	<h1 class="text-center text-white">REGISTRAR NUEVA SUCURSAL</h1>
	

	<div class="container p-5 ">
		<div class="d-flex justify-content-center h-100 p-3 mb-2 bg-gradient-secondary text-white">
			<form:form action="${pageContext.request.contextPath}/insertarData" method="POST" modelAttribute="sucursal">
				...
				<input type="submit" class="btn btn-dark btn-lg" value="Agregar nueva sucursal">
			</form:form>
		</div>	
